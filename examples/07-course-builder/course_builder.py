    ...
    Chapter("绪论", [
        Section(
            ...
            content_blocks=[
                ...
                paragraph("与传统「离身」AI 不同，具身智能要求智能体拥有身体，能通过传感器感知环境，通过执行器改变环境。"),
                heading3("核心特征"),
        ...
        Section(
            ...
            content_blocks=[
                heading2("具身智能的发展历程"),
                bullet(t("1948年", bold=True), t("：Wiener 出版《Cybernetics》，控制论奠定感知-行动闭环理论基础")),
                bullet(t("1961年", bold=True), t("：Unimate 安装于 GM 工厂，全球第一台工业机器人")),
                bullet(t("1991年", bold=True), t("：Brooks 提出「世界本身就是最好的模型」")),
                bullet(t("2016年", bold=True), t("：AlphaGo 展示从交互中超越人类先验知识的可能性")),
                bullet(t("2023年", bold=True), t("：Google RT-2 将大模型与机器人控制统一，VLA 模型诞生")),
                heading2("参考文献"),
                bullet(t("Wiener, N. (1948). Cybernetics. MIT Press.")),
                bullet(t("Silver, D. et al. (2016). Mastering the Game of Go. Nature, 529, 484-489.")),
            ],
            ppt_slides=[
                ("发展历程", [
                    "1948: 控制论 (Wiener)",
